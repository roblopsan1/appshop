    ...
    <div class="container">
        ...
        <div class="section text-center">
            ...
            <form method="post" action="" enctype="multipart/form-data">
                {{csrf_field()}}
                <!-- Si action esta vacio hace referencua al mismo archivo -->
                    ...
                    <div class="panel panel-default">
                        <div class="panel-body">
                            ...
                            <form method="post" action="">
                                ...
                                @if($image->featured)
                                <a type="button" class="btn btn-success btn-just-icon" rel="tooltip" title="Imágen destacada de este producto">
